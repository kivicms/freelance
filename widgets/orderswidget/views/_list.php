...
<div class="order-item">
	<div class="row">
		<div class="col-md-9">
			<img src="<?= $model->profile->getImage()->getUrl('70x70') ?>" class="img-circle" style="float: left"  alt=""/>

    		<h2><a  style="margin-left: 20px " href="<?= Url::toRoute(['/order/default/view', 'id' => $model->id]) ?>"><?= $model->title ?></a></h2>
    	</div>
    	<div class="col-md-3">
    		<h4>
