    ...
    <div class="comments row">
        <div class="col-md-12 col-sm-12">
            <div class="title-block clearfix">
                <a class="h3-body-title" href="#comments-block-<?= $pjaxContainerId ?>"  data-toggle="collapse">
                    <?php echo Yii::t('yii2mod.comments', 'Comments ({0})', $commentModel->getCommentsCount()); ?>
                </a>
                <div class="title-separator"></div>
            </div>
            <div id="comments-block-<?= $pjaxContainerId ?>" class="collapse bg-aqua color-palette disabled" style="padding: 10px">
